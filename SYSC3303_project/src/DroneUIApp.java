...
public class DroneUIApp {
    ...
    public static void main(String[] args) {
        ...
        List<Zone> zones = readZonesFromCSV("src/zone_file.csv");
        if (zones.isEmpty()) {
        ...
        // Start the simulation driver thread to send test updates
        Thread simulationThread = new Thread(new SimulationDriver(sharedQueue, zones, SCALE_METERS));
