...
public class DroneLogAnalyzer {
    /** Name of the log file where all events will be recorded */
    private static final String LOG_FILE = "drone_event_log.txt";
    /** Formatter for timestamping log entries in HH:mm:ss.SSS format */
    private static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("HH:mm:ss.SSS");
    /** Map storing individual drone logs, keyed by drone ID */
    private static final HashMap<String,List<LogEntry>> drones = new HashMap<>();
    /** General log entries related to drones (not per-drone specific) */
    private static final List<LogEntry> droneLogs = new ArrayList<>();
    /** Log entries generated by the processFault thread */
    private static final List<LogEntry> processFaultLogs = new ArrayList<>();
    /** Log entries generated by the thread listening to the scheduler */
    private static final List<LogEntry> schedulerListenerLogs = new ArrayList<>();
    /** Log entries from the main DroneSubsystem run loop */
    private static final List<LogEntry> subsystemLogs = new ArrayList<>();
    /** Timestamps marking the start and end of the program */
    private static LocalTime start = null;
    private static LocalTime end = null;
    /** Total runtime duration of the program */
    private static double programLife = 0;
    /** Total number of drones initialized during the program's lifetime */
